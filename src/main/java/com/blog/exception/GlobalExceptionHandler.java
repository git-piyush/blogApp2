...
import com.blog.responseDTO.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ErrorDetails> handleResourcrMismatchException(ResourceMismatchException exception, WebRequest webRequest){
	...
	public ResponseEntity<ErrorDetails> handleResourcrMismatchException(BlogApiException exception, WebRequest webRequest){
